 ...
 *
 * **텔레그램 그룹방 초대 링크는 넣지 않는다** (2026-08-14 결정). 방 주소는 볼트·레포
 * 어디에도 없다. 다만 **River 개인 DM은 예외**로 피드백 경로에 둔다(#11, 2026-08-23
 * River 지시) — 주소는 단일 쓰임이라 레지스트리가 아니라 `components/FeedbackBox.tsx`에
 * 인라인으로 산다. 문의는 하단 「한 줄 남기기」 또는 그 개인 DM으로 받는다.
 */
