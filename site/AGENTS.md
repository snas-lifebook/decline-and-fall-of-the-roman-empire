...
- 설계 맥락("왜 이렇게 만들었나")은 볼트 `Works/로마쇠망사_자료실/`에 산다. `openspec/`은 "무엇을 언제 바꿨나"를 쥔다. 둘을 섞지 않는다
- **헌장의 정본은 볼트 쪽이다.** 이 레포의 `CONSTITUTION.md`는 실행·코드리뷰용 미러다. 원칙을 고칠 일이 생기면 볼트를 먼저 고치고 여기를 맞춘다
